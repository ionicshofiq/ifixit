...
const Card = () => {
	return (
		<div className='flex gap-3 justify-center items-center py-10'>
			<div className='w-44 hover:-translate-y-3 duration-500 rounded-md border-slate-100 border-2 h-56 my-12 shadow-xl flex flex-col justify-between py-8 items-center '>
				<div
