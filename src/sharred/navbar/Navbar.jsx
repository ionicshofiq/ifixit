			...
			<div className='navbar-end flex justify-end items-center'>
				...
				>
					<div className='indicator relative'>
						...
						<span className='bg-[#f96331] text-white badge badge-md  indicator-item'>
							0
						</span>
					</div>
				</div>
				<a className='btn rounded-none bg-transparent border-[#f96331]'>
					Login
				</a>
			</div>
		</div>
